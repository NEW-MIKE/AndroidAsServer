...
public class Constant {
    ...
    public static String PATH_ROOT = FileUtils.createPublicRootPath() + File.separator+"ToupTek";
    public static String PATH_PICTURES = PATH_ROOT  + File.separator+ "images" + File.separator;
